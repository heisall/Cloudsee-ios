...
- (void)initOperationControllerMiddleViewwithFrame:(CGRect )newFrame
{
    ...
    [operationBigView updateViewWithTitleArray:[NSArray arrayWithObjects:NSLocalizedString(@"Audio", nil), NSLocalizedString(@"PTZ Control", nil),NSLocalizedString(@"Playback", nil),nil] detailArray:nil skinType:skinSelect];
