...
//    NSString *postSend = [NSString stringWithFormat:@"log_content=%@&ext=ios",content];
//    
//    NSString * post =  [postSend stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
//    
//    NSLog(@"post:%@",post);
//    
//    //   NSString *postMessage = (NSString *)CFURLCreateStringByAddingPercentEscapes(NULL, (CFStringRef)post, NULL, (CFStringRef)@"!*’();:@&=+$,/?%#[]", kCFStringEncodingUTF8);
//    
//    //将NSSrring格式的参数转换格式为NSData，POST提交必须用NSData数据。
//    NSData *postData = [post dataUsingEncoding:NSUTF8StringEncoding allowLossyConversion:YES];
//    //计算POST提交数据的长度
//    NSString *postLength = [NSString stringWithFormat:@"%d",[postMessage length]];
...
//    [request setValue:(NSString *)KMULTIPART forHTTPHeaderField:@"Content-Type"];
////    multipart/form-data
